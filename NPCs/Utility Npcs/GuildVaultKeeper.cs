/*
 * Guild Vault Keeper - Kakuri Mar 20 2009
 * A fake GameHouseVault that works as an Guild vault.
...
namespace DOL.GS
{
    ...
    public class GuildVault : GameHouseVault
    {
        ...
        /// <summary>
        /// An Guild vault that masquerades as a house vault to the game client
        /// </summary>
        ...
        /// <param name="vaultOwner">ID of vault owner (can be anything unique, if it's the Guild name then all toons on Guild can access the items)</param>
        ...
        public GuildVault(GamePlayer player, GameNPC vaultNPC, string vaultOwner, int vaultNumber, ItemTemplate dummyTemplate)
