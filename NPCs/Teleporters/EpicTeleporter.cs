...
namespace DOL.GS.Scripts
{
	public class EpicTeleporter: GameNPC
	{
		...
		public override bool Interact(GamePlayer player)
		{
			...
			player.Out.SendMessage("Hello "+player.Name+"! I can teleport you to face the [Dragon] but remember, you must gather a group to survive the battle.", eChatType.CT_Say,eChatLoc.CL_PopupWindow);
			return true;
		}
		public override bool WhisperReceive(GameLiving source, string str)
		{
			...
			switch(str)
			{
                ...
                case "Dragon":
                    SendReply(t, "Would you dure you would like to challenge [Gjalpinulva]?.");
                    break;
