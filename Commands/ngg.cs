        ...
        public static void OnScriptCompiled(DOLEvent e, object sender, EventArgs args)
        {
            ...
            for (int a = 0; a < 6; a++)
            {
                ...
                for (int b = 0; b < 6; b++)
                {
                   ...
                   temp = DOLDB<ItemTemplate>.SelectObjects(DB.Column("Object_Type").IsEqualTo(ot[a]).And(DB.Column("Item_Type").IsEqualTo(slots[b])));
            ...
            x = 0;
            temp = DOLDB<ItemTemplate>.SelectObjects(DB.Column("Item_Type").IsEqualTo(slots[6]));
            ...
            {
                x = 0;
                temp = DOLDB<ItemTemplate>.SelectObjects(DB.Column("Item_Type").IsEqualTo(slots[a]));
